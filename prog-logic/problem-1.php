    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Problem number 1</h1>
            </div>
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <?php
                        $currCode = $row['cuscde'];
                        $query2 = "Select * from salesfile1 where cuscde='$currCode'";
                        $res2 = $conn->prepare($query2);
                        $res2->execute();
                            if($res->rowCount());
                                while($row2 = $res2->fetch(PDO::FETCH_ASSOC)){

                                    $currTotal = $currTotal + $row2['trntot'];
                                    $grandTotal = $grandTotal + $row2['trntot'];
                                    
                    ?>
                        <tr>
                            <td><?php echo $row2['trndte']; ?></td>
                            <td><?php echo $row2['docnum']; ?></td>
                            <td style="text-align:right;"><?php echo number_format($row2['trntot'],2); ?></td>
                        </tr>
                    <?php 
                                }
                            ...
                            <tr>
                                <td style="border-top:0.5px solid; border-bottom:0.5px solid;"><b>Sub Total</b></td>
                                <td style="border-top:0.5px solid; border-bottom:0.5px solid;"></td>
                                <td style="text-align:right; border-top:0.5px solid; border-bottom:0.5px solid;"><?php echo number_format($currTotal,2); ?></td>
                            </tr>
                    ...
                    ?>
                            ...
                            <tr>
                                <td style="border-top:2px solid;""><b>Grand Total</b></td>
                                <td style="border-top:2px solid;""></td>
                                <td style="text-align:right; border-top:2px solid;"><b>
                                <?php
