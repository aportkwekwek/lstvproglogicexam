    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Problem number 5</h1>
                <button class="btn btn-info" id="btnRmDupe">Remove duplicate keys</button>
            </div>
            <div class="table-responsive">
                <table class="table table-striped table-sm" id="lastTable">
                    <thead>
                        <tr>
                            <th>RECID</th>
                            <th>Field 1</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>1</td>
                            <td class="sama1">f1-001</td>
                            <td class="sama2">f2-001</td>
                            <td class="sama">f3-001</td>
                        </tr>

                        <tr>
                            <td>2</td>
                            <td class="sama1">f1-001</td>
                            <td class="sama2">f2-001x</td>
                            <td class="sama">f3-001</td>
                        </tr>
                        ...
                        <tr>
                            <td>4</td>
                            <td class="sama1">f1-002</td>
                            <td class="sama2">f2-002</td>
                            <td class="sama">f3-002x</td>
                        </tr>
                        ...
                        <tr>
                            <td>7</td>
                            <td class="sama1">f1-003</td>
                            <td class="sama2">f2-003</td>
                            <td class="sama">f3-003</td>
                        </tr>
